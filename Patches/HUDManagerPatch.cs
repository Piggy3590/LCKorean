...
namespace LCKR.Patches
{
    ...
    internal class HUDManagerPatch
    {
            ...
            ref TextMeshProUGUI ___holdButtonToEndGameEarlyText, ref TextMeshProUGUI ___holdButtonToEndGameEarlyVotesText)
        {
            ...
            ___holdButtonToEndGameEarlyText.text = TranslationManager.ReplaceArrayText(___holdButtonToEndGameEarlyText.text, "HUD",
                "Tell autopilot ship to leave early");
            ___holdButtonToEndGameEarlyText.text = TranslationManager.ReplaceArrayText(___holdButtonToEndGameEarlyText.text, "HUD",
                "Voted for ship to leave early");
            ___holdButtonToEndGameEarlyText.text = TranslationManager.ReplaceArrayText(___holdButtonToEndGameEarlyText.text, "HUD",
                "Hold");
            ___holdButtonToEndGameEarlyVotesText.text = TranslationManager.ReplaceArrayText(___holdButtonToEndGameEarlyVotesText.text, "HUD",
                "Votes");
        ...
        {
            ___spectatorTipText.text = TranslationManager.ReplaceArrayText(___spectatorTipText.text, "HUD", "TIP!: Hold [R-Trigger] to vote for the autopilot ship to leave early.");
            ___spectatorTipText.text = TranslationManager.ReplaceArrayText(___spectatorTipText.text, "HUD", "TIP!: Hold [RMB] to vote for the autopilot ship to leave early.");
        }
        ...
        private static void DisplayStatusEffect_Postfix(string statusEffect, ref TextMeshProUGUI ___statusEffectText)
        {
            ...
            {
                ___statusEffectText.text = TranslationManager.ReplaceArrayText(___statusEffectText.text, "HUD", "SteamLeakDetected");
            }
        }
            ...
            foreach (DialogueSegment dialogue in dialogueArray)
            {
                ...
                if (dialogue.bodyText == "AM. A vote has been cast")
                {
                    dialogue.bodyText = TranslationManager.GetArrayTranslation("Dialogue", "ReturnAM")
                        .Replace("{time}", HUDManager.Instance.GetClockTimeFormatted(TimeOfDay.Instance.shipLeaveAutomaticallyTime, (float)TimeOfDay.Instance.numberOfHours, false));
                }
