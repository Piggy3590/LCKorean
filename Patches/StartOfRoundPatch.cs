...
namespace LCKR.Patches
{
    ...
    internal class StartOfRoundPatch
    {
        ...
        private static void LateUpdate_Prefix()
        {
            HUDManager.Instance.planetInfoSummaryText.text = TranslationManager.GetArrayTranslation("Planets",
                StartOfRound.Instance.currentLevel.LevelDescription, 0, true);
        }
